...
export default function Sidebar({ profileImage }: SidebarProps) {
  ...
  return (
    <aside 
      className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-[#111] text-white transition-all duration-300 flex flex-col relative z-20 shrink-0`}
    >
      ...
      <nav className="flex-1 px-4 space-y-4 mt-4 overflow-hidden">
        <Link 
          ...
          className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-800 transition group cursor-pointer whitespace-nowrap"
        >
          <div className="w-8 h-8 min-w-[2rem] rounded-full overflow-hidden border border-gray-600 bg-gray-700">
            {profileImage ? (
        ...
        <Link 
          ...
          className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-800 transition group cursor-pointer whitespace-nowrap"
        >
          <div className="w-8 h-8 min-w-[2rem] rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 group-hover:text-white">
