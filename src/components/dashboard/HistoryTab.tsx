  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Professional History</h2>
        {!isFormOpen && (
          <button 
          ...
          <form action={async (formData) => {
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <input 
                ...
                required 
                className="p-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition"
              />
              <input 
                name="role" 
      ...
      <div className="space-y-4">
        {experiences.map((exp) => (
          <div key={exp.id} className="bg-white p-6 rounded-xl border border-gray-200 flex justify-between items-start hover:shadow-md transition group">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500 font-medium mb-2">{exp.role} | {exp.duration}</div>
